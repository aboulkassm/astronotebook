class App {
  ...
  addEventListeners() {
    document.body.addEventListener("click", event => {
      if (this.deleteNote(event)) return;
    ...
    document.body.addEventListener('mouseout', event => {
      if (!event.target.matches('.toolbar-color')) this.closeTooltip();
    });
    ...
    this.$colorTooltip.addEventListener('mouseout', () => {
  ...
  deleteNote(event) {
    if(event.target.matches('.toolbar-delete')) {
        ...
        const selectedId = Number($selectedNote.dataset.id);
      ...
      .map(
        ...
        <div style="background: ${note.color};" class="note" data-id="${
          ...
          <div class="toolbar-container">
              <div class="toolbar">
                  <img class="toolbar-color" src="palette.png">
